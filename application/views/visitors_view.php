                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <button id="btn_new" class="btn btn-primary waves-effect waves-light" type="button"><span class="btn-label"><i class="mdi mdi-account-plus fa-fw"></i></span>Add New Visitor</button>
