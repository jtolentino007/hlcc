            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-primary">Group</h4>
                    </div>
                ...
                <!-- CONTENT -->
                <!-- ============================================================== -->
                <div id="div_tbl_group">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                <h3 class="box-title m-b-0 text-primary b-b">View Group</h3><br>
                                <!-- <p class="text-muted m-b-30">Data table example</p> -->
                                <button id="btn_new" class="btn btn-primary waves-effect waves-light" type="button"><span class="btn-label"><i class="mdi mdi-plus fa-fw"></i></span>Add New Group</button>
                                <div class="table-responsive">
                                    <table id="tbl_group" class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th>Group</th>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box p-l-20 p-r-20">
                                <h3 class="box-title m-b-0 text-primary b-b">Add New Group</h3>
                                <br><br>
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="frm_group" class="floating-labels" data-toggle="validator">
                                            <div class="form-group m-b-40">
                                                <input type="text" class="form-control tooltip-info" name="group_name" id="name" data-toggle="tooltip" data-placement="bottom" title="Group Name" data-error="Please put the Group Name." required><span class="highlight"></span> <span class="bar"></span>
                                                <label for="name">Group Name</label>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                            <div class="form-group m-b-40">
                                                <input type="text" class="form-control tooltip-info" name="group_description" id="leader" data-toggle="tooltip" data-placement="bottom" title="Group Description" data-error="Give a short description of the group." required><span class="highlight"></span> <span class="bar"></span>
                                                <label for="leader">Group Description</label>
                                                <div class="help-block with-errors"></div>
                                            </div>
        ...
        $(document).ready(function(){
            ...
            var initializeControls=function() {
                ...
                dt=$('#tbl_group').DataTable({
                    ...
                    "ajax" : "Group/transaction/list",
                    "columns": [
                        { targets:[0],data: "group_name" },
                        { targets:[1],data: "group_description" },
                        {
                            targets:[2],
            ...
            // To edit form
            $('#tbl_group tbody').on('click','button[name="edit_info"]',function(){
                _txnMode="edit";
            ...
            $('#tbl_group tbody').on('click','button[name="remove_info"]',function(){
                _selectRowObj=$(this).closest('tr');
                var data=dt.row(_selectRowObj).data();
                _selectedID=data.group_id;
            ...
            $('#sa-warning').click(function(){
                swal({   
                    ...
                    swal("Deleted!", "Group information successfully deleted.", "success")
                    removeGroup().done(function(response){
            ...
            $('#btn_save').click(function(){
                if(validateRequiredFields($('#frm_group'))){
                    ...
                    if(_txnMode==="edit"){
                        updateGroup().done(function(response){
                            showNotification(response);
