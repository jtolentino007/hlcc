            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title text-primary">Schools</h4>
                    </div>
                ...
                <!-- CONTENT -->
                <!-- ============================================================== -->
                <div id="div_tbl_school">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box">
                                <h3 class="box-title m-b-0 text-primary b-b">View Schools</h3><br>
                                <!-- <p class="text-muted m-b-30">Data table example</p> -->
                                <button id="btn_new" class="btn btn-primary waves-effect waves-light" type="button"><span class="btn-label"><i class="mdi mdi-plus fa-fw"></i></span>Add New School</button>
                ...
                <!-- .row -->
                <div id="div_add_school">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box p-l-20 p-r-20">
                                <h3 class="box-title m-b-0 text-primary b-b">Add New School</h3>
                                <br><br>
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="frm_school" class="floating-labels" data-toggle="validator">
                                            <div class="form-group m-b-40">
                                                <input type="text" class="form-control tooltip-info" name="school_name" id="name" data-toggle="tooltip" data-placement="bottom" title="School Name" data-error="Please put the School." required><span class="highlight"></span> <span class="bar"></span>
        ...
        $(document).ready(function(){
            ...
            var initializeControls=function() {
                ...
                dt=$('#tbl_school').DataTable({
                    ...
                    "columns": [
                        { targets:[0],data: "school_name" },
                        { targets:[1],data: "school_description" },
                        {
                            targets:[2],
            ...
            // To edit form
            $('#tbl_school tbody').on('click','button[name="edit_info"]',function(){
                _txnMode="edit";
                _selectRowObj=$(this).closest('tr');
                var data=dt.row(_selectRowObj).data();
                _selectedID=data.school_id;
            ...
            $('#tbl_school tbody').on('click','button[name="remove_info"]',function(){
                _selectRowObj=$(this).closest('tr');
                var data=dt.row(_selectRowObj).data();
                _selectedID=data.school_id;
            ...
            $('#sa-warning').click(function(){
                swal({   
                    ...
                    swal("Deleted!", "School information successfully deleted.", "success")
                    removeSchool().done(function(response){
            ...
            $('#btn_save').click(function(){
                if(validateRequiredFields($('#frm_school'))){
                    if(_txnMode=="new"){
                        createSchool().done(function(response){
                            showNotification(response);
                    ...
                    if(_txnMode==="edit"){
                        updateSchool().done(function(response){
                            showNotification(response);
            ...
            var createSchool=function(){
                var _data=$('#frm_school').serializeArray();

                return $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":"School/transaction/create",
                    "data":_data,
            ...
            var updateSchool=function() {
                var _data=$('#frm_school').serializeArray();
                _data.push({name : "school_id" ,value : _selectedID});

                return $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":"School/transaction/update",
                    "data":_data,
                    "beforeSend": showSpinningProgress($('#btn_save'))
                });
            };
            ...
            var removeSchool=function() {
                return $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":"School/transaction/delete",
                    "data":{school_id : _selectedID}
                });
            };
